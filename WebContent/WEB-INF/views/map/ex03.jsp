...
<body>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=55ab69bc871b766267ae1612c1e51daf"></script>
	...
	<script>
		...
		daum.maps.event.addListener(map, "click", function(evt) {
			...
			$("#msg").text(
					"클릭한 위치: 위도" + evt.latLng.getLat() + ", 경도 "
							+ evt.latLng.getLng());
			...
			marker1 = new daum.maps.Marker({
				position : new daum.maps.LatLng(evt.latLng.getLat(), evt.latLng
						.getLng())
			});
